...
# @LogInfo('full')
# def server(addr=DEFAULT_ADDR, port=DEFAULT_PORT):
#     server_socket = socket(AF_INET, SOCK_STREAM)
#     server_socket.setsockopt(
#         SOL_SOCKET,
#         SO_REUSEADDR,
#         1)
#     server_socket.bind(args_validation(addr, port))
...
#         clients[client_socket] = nike_name

#         broadcast(f'{nike_name} is joined!\n', client_socket)
...
#     if message_command in clients.values():
...
#         user_list = '\n'.join([_ for _ in clients.values()])
